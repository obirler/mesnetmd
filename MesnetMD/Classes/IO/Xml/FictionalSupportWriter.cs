...
{
    public class FictionalSupportWriter
    {
        public FictionalSupportWriter(System.Xml.XmlWriter writer, FictionalSupport support)
        {
            _writer = writer;
        ...
        public void Write()
        {
            _writer.WriteStartElement("FictionalSupport");
