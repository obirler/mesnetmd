...
{
    public class ShearForce : GraphicItem, IGraphic
    {
        ...
        private PiecewisePoly _shearforceppoly;
        ...
        public void Draw(int c)
        {
            ...
            leftpoints.Add(new Point(0, coeff * _shearforceppoly.Calculate(0)));
            ...
            foreach (Poly poly in _shearforceppoly)
            {
            ...
            var point1 = new Point(100 * _beam.Length, coeff * _shearforceppoly.Calculate(_beam.Length));
            ...
            double max = _shearforceppoly.Max;
            double maxlocation = _shearforceppoly.MaxLocation;
            double min = _shearforceppoly.Min;
            double minlocation = _shearforceppoly.MinLocation;

            starttext = createtextblock();
            _beam.Children.Add(starttext);
            starttext.Text = System.Math.Round(_shearforceppoly.Calculate(0), 1) + " kN";
            ...
            calculated = coeff * _shearforceppoly.Calculate(0);
            ...
            endtext.Text = System.Math.Round(_shearforceppoly.Calculate(_beam.Length), 1) + " kN";
            ...
            calculated = coeff * _shearforceppoly.Calculate(_beam.Length);
        ...
        public PiecewisePoly ShearForcePpoly
        {
            get { return _shearforceppoly; }
            set { _shearforceppoly = value; }
        }
    }
}
